...
var flagList = ["🇧🇿", "🇱🇸", "🇳🇬", "🇬🇩", "🇨🇦", "🇬🇭", "🇷🇺", "🇹🇻", "🇨🇾", "🇧🇸", "🇸🇨", "🏴󠁧󠁢󠁥󠁮󠁧󠁿", "🇬🇾", "🇵🇭", "🇧🇴", "🇦🇪", "🇹🇿", "🇪🇹", "🇲🇳", "🇸🇦", "🇱🇮", "🇵🇦", "🇶🇦", "🇭🇺", "🇳🇪", "🇺🇾", "🇳🇱", "🇲🇿", "🇹🇲", "🇨🇿", "🇸🇴", "🇦🇱", "🇪🇬", "🇳🇷", "🇷🇴", "🇿🇦", "🇲🇱", "🇨🇷", "🇨🇮", "🇰🇷", "🇧🇯", "🇺🇬", "🇲🇭", "🇿🇼", "🇱🇹", "🇦🇿", "🇲🇬", "🇸🇿", "🇮🇶", "🇸🇪", "🇮🇪", "🇹🇬", "🇯🇴", "🇴🇲", "🇰🇬", "🇮🇸", "🇨🇭", "🇨🇩", "🇽🇰", "🇧🇮", "🇬🇹", "🇸🇳", "🇲🇩", "🇧🇭", "🇱🇷", "🇾🇪", "🇬🇷", "🇰🇵", "🇩🇴", "🇿🇦", "🇬🇦", "🇬🇳", "🇬🇶", "🇲🇨", "🇰🇳", "🇱🇾", "🇸🇱", "🇦🇬", "🇭🇷", "🇸🇹", "🇲🇼", "🇳🇮", "🇳🇵", "🇻🇺", "🇼🇸", "🇵🇪", "🇻🇳", "🇺🇦", "🇮🇩", "🇪🇷", "🇨🇲", "🇯🇲", "🇨🇱", "🇵🇾", "🇭🇹", "🇬🇪", "🇲🇪", "🇧🇹", "🇧🇫", "🇹🇭", "🇨🇺", "🇲🇦", "🇰🇪", "🇱🇺", "🇧🇩", "🇸🇬", "🇲🇰", "🇲🇷", "🇷🇸", "🇺🇿", "🇹🇱", "🇵🇬", "🇧🇳", "🇨🇳", "🇪🇸", "🇪🇨", "🇵🇹", "🇦🇲", "🇩🇿", "🇹🇴", "🇸🇮", "🇳🇿", "🇧🇬", "🇦🇷", "🏴󠁧󠁢󠁳󠁣󠁴󠁿", "🇮🇱", "🇱🇨", "🇳🇦", "🇦🇫", "🇰🇼", "🇸🇲", "🇵🇰", "🇨🇴", "🇦🇺", "🇰🇭", "🇫🇲", "🇹🇩", "🇫🇯", "🇿🇲", "🇧🇦", "🇧🇾", "🇹🇷", "🇫🇮", "🏴󠁧󠁢󠁷󠁬󠁳󠁿", "🇺🇸", "🇻🇦", "🇸🇧", "🇲🇾", "🇦🇩", "🇲🇽", "🇹🇳", "🇮🇷", "🇧🇼", "🇱🇻", "🇳🇴", "🇯🇵", "🇲🇺", "🇸🇾", "🇩🇲", "🇱🇰", "🇸🇰", "🇪🇪", "🇸🇷", "🇰🇮", "🇹🇹", "🇬🇼", "🇨🇫", "🇧🇷", "🇱🇦", "🇩🇰", "🇮🇳", "🇲🇹", "🇰🇲", "🇧🇪", "🇬🇲", "🇦🇴", "🇸🇻", "🇩🇯", "🇮🇹", "austria", "eswatini", "barbados", "caboverde", "poland", "france", "taiwan", "honduras", "kazakhstan", "southsudan", "venezuela", "maldives", "tajikistan", "southafrica", "sudan", "lebanon", "saintvincentandthegrenadines", "germany", "myanmar", "rwanda", "palau", "bolivia", "republicofthecongo", "equatorialguinea", "palestine", "🇬🇧", "🏴󠁧󠁢󠁮󠁩󠁲󠁿",];
