...
var flagList = ["🇧🇿", "🇱🇸", "🇳🇬", "🇬🇩", "🇨🇦", "🇬🇭", "🇷🇺", "🇹🇻", "🇨🇾", "🇧🇸", "🇸🇨", "🏴󠁧󠁢󠁥󠁮󠁧󠁿", "🇬🇾", "🇵🇭", "🇧🇴", "🇦🇪", "🇹🇿", "🇪🇹", "🇲🇳", "🇸🇦", "🇱🇮", "🇵🇦", "🇶🇦", "🇭🇺", "🇳🇪", "🇺🇾", "🇳🇱", "🇲🇿", "🇹🇲", "🇨🇿", "🇸🇴", "🇦🇱", "🇪🇬", "🇳🇷", "🇷🇴", "🇿🇦", "🇲🇱", "🇨🇷", "🇨🇮", "🇰🇷", "🇧🇯", "🇺🇬", "🇲🇭", "🇿🇼", "🇱🇹", "🇦🇿", "🇲🇬", "🇸🇿", "🇮🇶", "🇸🇪", "🇮🇪", "🇹🇬", "🇯🇴", "🇴🇲", "🇰🇬", "🇮🇸", "🇨🇭", "🇨🇩", "🇽🇰", "🇧🇮", "🇬🇹", "🇸🇳", "🇲🇩", "🇧🇭", "🇱🇷", "🇾🇪", "🇬🇷", "🇰🇵", "🇩🇴", "🇿🇦", "🇬🇦", "🇬🇳", "🇬🇶", "🇲🇨", "🇰🇳", "🇱🇾", "🇸🇱", "🇦🇬", "🇭🇷", "🇸🇹", "🇲🇼", "🇳🇮", "🇳🇵", "🇻🇺", "🇼🇸", "🇵🇪", "🇻🇳", "🇺🇦", "🇮🇩", "🇪🇷", "🇨🇲", "🇯🇲", "🇨🇱", "🇵🇾", "🇭🇹", "🇬🇪", "🇲🇪", "🇧🇹", "🇧🇫", "🇹🇭", "🇨🇺", "🇲🇦", "🇰🇪", "🇱🇺", "🇧🇩", "🇸🇬", "🇲🇰", "🇲🇷", "🇷🇸", "🇺🇿", "🇹🇱", "🇵🇬", "🇧🇳", "🇨🇳", "🇪🇸", "🇪🇨", "🇵🇹", "🇦🇲", "🇩🇿", "🇹🇴", "🇸🇮", "🇳🇿", "🇧🇬", "🇦🇷", "🏴󠁧󠁢󠁳󠁣󠁴󠁿", "🇮🇱", "🇱🇨", "🇳🇦", "🇦🇫", "🇰🇼", "🇸🇲", "🇵🇰", "🇨🇴", "🇦🇺", "🇰🇭", "🇫🇲", "🇹🇩", "🇫🇯", "🇿🇲", "🇧🇦", "🇧🇾", "🇹🇷", "🇫🇮", "🏴󠁧󠁢󠁷󠁬󠁳󠁿", "🇺🇸", "🇻🇦", "🇸🇧", "🇲🇾", "🇦🇩", "🇲🇽", "🇹🇳", "🇮🇷", "🇧🇼", "🇱🇻", "🇳🇴", "🇯🇵", "🇲🇺", "🇸🇾", "🇩🇲", "🇱🇰", "🇸🇰", "🇪🇪", "🇸🇷", "🇰🇮", "🇹🇹", "🇬🇼", "🇨🇫", "🇧🇷", "🇱🇦", "🇩🇰", "🇮🇳", "🇲🇹", "🇰🇲", "🇧🇪", "🇬🇲", "🇦🇴", "🇸🇻", "🇩🇯", "🇮🇹", "🇦🇹", "🇸🇿", "🇧🇧", "🇨🇻", "🇵🇱", "🇫🇷", "🇹🇼", "🇭🇳", "🇰🇿", "🇸🇸", "🇻🇪", "🇲🇻", "tajikistan", "southafrica", "sudan", "lebanon", "saintvincentandthegrenadines", "germany", "myanmar", "rwanda", "palau", "bolivia", "republicofthecongo", "equatorialguinea", "palestine", "🇬🇧", "🏴󠁧󠁢󠁮󠁩󠁲󠁿",];
