...
var flagList = ["🇧🇿", "🇱🇸", "🇳🇬", "🇬🇩", "🇨🇦", "🇬🇭", "🇷🇺", "🇹🇻", "🇨🇾", "🇧🇸", "🇸🇨", "🏴󠁧󠁢󠁥󠁮󠁧󠁿", "🇬🇾", "🇵🇭", "🇧🇴", "🇦🇪", "🇹🇿", "🇪🇹", "🇲🇳", "🇸🇦", "🇱🇮", "🇵🇦", "🇶🇦", "🇭🇺", "🇳🇪", "🇺🇾", "🇳🇱", "🇲🇿", "🇹🇲", "🇨🇿", "🇸🇴", "🇦🇱", "🇪🇬", "🇳🇷", "🇷🇴", "🇿🇦", "🇲🇱", "🇨🇷", "🇨🇮", "🇰🇷", "🇧🇯", "🇺🇬", "🇲🇭", "🇿🇼", "🇱🇹", "🇦🇿", "🇲🇬", "🇸🇿", "🇮🇶", "🇸🇪", "🇮🇪", "🇹🇬", "🇯🇴", "🇴🇲", "🇰🇬", "🇮🇸", "🇨🇭", "🇨🇩", "🇽🇰", "🇧🇮", "🇬🇹", "🇸🇳", "🇲🇩", "🇧🇭", "🇱🇷", "🇾🇪", "🇬🇷", "🇰🇵", "🇩🇴", "🇿🇦", "🇬🇦", "🇬🇳", "🇬🇶", "🇲🇨", "🇰🇳", "🇱🇾", "🇸🇱", "🇦🇬", "🇭🇷", "🇸🇹", "🇲🇼", "🇳🇮", "🇳🇵", "🇻🇺", "🇼🇸", "🇵🇪", "🇻🇳", "🇺🇦", "🇮🇩", "🇪🇷", "🇨🇲", "🇯🇲", "🇨🇱", "🇵🇾", "🇭🇹", "🇬🇪", "🇲🇪", "🇧🇹", "🇧🇫", "🇹🇭", "🇨🇺", "🇲🇦", "🇰🇪", "🇱🇺", "🇧🇩", "🇸🇬", "🇲🇰", "🇲🇷", "🇷🇸", "🇺🇿", "🇹🇱", "🇵🇬", "🇧🇳", "🇨🇳", "🇪🇸", "🇪🇨", "🇵🇹", "🇦🇲", "🇩🇿", "🇹🇴", "🇸🇮", "🇳🇿", "🇧🇬", "🇦🇷", "🏴󠁧󠁢󠁳󠁣󠁴󠁿", "🇮🇱", "🇱🇨", "🇳🇦", "🇦🇫", "🇰🇼", "🇸🇲", "🇵🇰", "🇨🇴", "🇦🇺", "🇰🇭", "🇫🇲", "🇹🇩", "🇫🇯", "🇿🇲", "🇧🇦", "🇧🇾", "🇹🇷", "🇫🇮", "🏴󠁧󠁢󠁷󠁬󠁳󠁿", "🇺🇸", "🇻🇦", "🇸🇧", "🇲🇾", "🇦🇩", "🇲🇽", "🇹🇳", "🇮🇷", "🇧🇼", "🇱🇻", "🇳🇴", "🇯🇵", "🇲🇺", "🇸🇾", "🇩🇲", "🇱🇰", "🇸🇰", "🇪🇪", "🇸🇷", "🇰🇮", "🇹🇹", "🇬🇼", "🇨🇫", "🇧🇷", "🇱🇦", "🇩🇰", "🇮🇳", "🇲🇹", "🇰🇲", "🇧🇪", "🇬🇲", "🇦🇴", "🇸🇻", "🇩🇯", "🇮🇹", "🇦🇹", "🇸🇿", "🇧🇧", "🇨🇻", "🇵🇱", "🇫🇷", "🇹🇼", "🇭🇳", "🇰🇿", "🇸🇸", "🇻🇪", "🇲🇻", "🇹🇯", "🇿🇦", "🇸🇩", "🇱🇧", "saintvincentandthegrenadines", "germany", "myanmar", "rwanda", "palau", "bolivia", "republicofthecongo", "equatorialguinea", "palestine", "🇬🇧", "🏴󠁧󠁢󠁮󠁩󠁲󠁿",];
